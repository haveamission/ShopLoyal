...
class Card extends Component {
  ...
  launchInsiderModal() {
    toast.info(
      <span>
        Success! You've favorited a merchant. Now{" "}
        <span class="find-more">
          <Link to="/">favorite more merchants</Link>
        </span>
      </span>,
      {
  ...
  handleCallClick(e) {
    if (this.state.merchant.isFavorite === false) {
      ...
      e.stopPropagation();
      this.launchErrorModal(
        "You need to favorite this merchant before calling them"
      );
    }
  }
          ...
          <div className="card-right-bottom">
            ...
            <div className="card-nav">
              <ul>
                ...
                <a onClick={this.handleCallClick} href={this.createCallLink()}>
                  <li>
                    Call
                    <img src={Call} />
                  </li>
                ...
                <Link
                  to={{
                    ...
                    state: {
                      merchant_lat: this.state.merchant.latitude,
